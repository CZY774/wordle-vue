  ...
  >
      ...
      <div class="max-w-md mx-auto flex justify-between items-center">
        <div class="flex gap-2">
          <button
            ...
            class="p-2 hover:bg-muted rounded transition-colors duration-200"
        ...
        <h1 class="text-2xl font-bold tracking-wider">WORDLE</h1>
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div v-else class="max-w-md mx-auto">
        <!-- Game Grid -->
        <div
          class="grid grid-rows-6 gap-2 mb-8"
          role="grid"
        ...
        >
          <div
            ...
            :key="rowIndex"
            class="grid grid-cols-5 gap-2 transition-transform duration-300"
          ...
          >
            <div
              ...
              :key="colIndex"
              class="w-12 h-12 border-2 border-border rounded flex items-center justify-center text-lg font-bold uppercase transition-all duration-300 select-none"
        ...
        <!-- Game Status -->
        <div class="text-center mb-6 min-h-[60px] flex flex-col justify-center">
          <div
            v-if="gameStatus === 'won'"
            class="text-green-400 animate-bounce-in"
          >
            <p class="text-xl font-bold mb-2">🎉 Fantastic!</p>
            <p class="mb-3">
              You guessed the word in {{ currentRow + 1 }} tries!
            </p>
            <button
              @click="shareResults"
              class="flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg font-bold hover:bg-green-700 transition-colors duration-200 mx-auto"
          ...
          >
            <p class="text-xl font-bold mb-2">💀 Game Over!</p>
            <p class="mb-3">
              The word was:
            ...
            <button
              @click="shareResults"
              class="flex items-center gap-2 px-4 py-2 bg-red-600 text-white rounded-lg font-bold hover:bg-red-700 transition-colors duration-200 mx-auto"
              :disabled="shareButtonText !== 'Share'"
            >
              <!-- Share Icon -->
              <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div v-else-if="error" class="text-red-400 font-bold animate-shake">
            {{ error }}
          </div>
          <div
          ...
          >
            <p>Guess the WORDLE in {{ MAX_GUESSES }} tries</p>
            <p v-if="hardMode" class="text-yellow-400 mt-1">
        ...
        <!-- Virtual Keyboard -->
        <div class="space-y-2" role="group" :aria-label="'Virtual keyboard'">
          <div
          ...
          >
            <button
              ...
              class="px-2 py-3 rounded font-bold text-sm transition-all duration-200 min-w-[32px] h-12 flex items-center justify-center select-none focus:outline-none focus:ring-2 focus:ring-primary active:transform active:scale-95"
    ...
    >
      <div class="bg-card rounded-lg p-6 max-w-sm w-full animate-fade-in">
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-xl font-bold text-foreground">Statistics</h2>
          <button
        ...
        <div class="mb-4">
          ...
          <div class="space-y-1">
            ...
            >
              ...
              <div class="flex-1 bg-muted rounded h-5 relative overflow-hidden">
                <div
                  class="bg-green-600 h-full rounded transition-all duration-500"
                  :style="{ width: `${(count / maxGuessCount) * 100}%` }"
                />
                <div
                  class="absolute right-2 top-0 text-foreground text-xs leading-5"
                >
                  {{ count }}
                </div>
              </div>
        ...
        <div class="text-center">
          <button
            @click="showStats = false"
            class="px-6 py-2 bg-primary text-primary-foreground rounded-lg font-bold hover:bg-primary/90 transition-colors duration-200"
          >
            Close
          </button>
        </div>
